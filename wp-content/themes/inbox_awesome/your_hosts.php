...
<div class="speakers_content" >
  ...
  foreach($your_hosts as $your_host){ ?>
    <div class="cell">

    <div class="radius_image">
      <img src="<?php echo get_the_post_thumbnail_url($your_host->ID); ?>">
    </div>
      <p class="name"><?php echo $your_host->post_title; ?></p>
      <p class="description"><?php
        echo get_post_meta($your_host->ID, 'Description', true);
      ?></p>
      <p class="company"><?php
        echo get_post_meta($your_host->ID, 'Company', true);
      ?></p>


      <p class="speaker-links">
        <?php
          $twitterLink  = get_post_meta($your_host->ID, 'twitterLink', true);
          $linkedinLink = get_post_meta($your_host->ID, 'linkedinLink', true);
