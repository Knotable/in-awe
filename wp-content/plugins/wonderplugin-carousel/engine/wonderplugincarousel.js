...
(function($) {
    $.fn.wondercarousellightbox = function(options) {
        ...
        inst.createMarkup = function() {
            ...
            inst.$lightbox = jQuery("<div id='carousel-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;min-height:100%;background-color:" + inst.options.overlaybgcolor + ";opacity:" + inst.options.overlayopacity +
        ...
        inst.embedHTML5Video = function($container, src, autoplay) {
            ...
            if (!inst.options.nativehtml5controls) {
                ...
                $("video", $container).acLightboxHTML5VideoControls(inst.options.skinsfolder, inst, inst.options.videohidecontrols, false, inst.options.defaultvideovolume)
            }
        };
...
(function($) {
    $.fn.acLightboxHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton, defaultvolume) {
    ...
    $.fn.wonderplugincarousel = function(options) {
        ...
        AmazingCarousel.prototype = {
                ...
                if ($img.length) {
                    $img.one("load", function() {
                        if (instance.options.fixaspectratio) {
                            ...
                            if (imgW > 0 && imgH && imgW / imgH > instance.options.width / instance.options.height) $(this).css({
                                width: "auto",
                                height: "100%",
                                "max-width": "none",
                                "max-height": "100%"
            ...
            createHoverOverlay: function() {
                ...
                if (this.options.hidehoveroverlayontouch && "ontouchstart" in window) return;
                var instance = this;
                $(".amazingcarousel-image", this.container).each(function() {
                    var $this = $(this);
            ...
            createItemBottomShadow: function() {
                ...
                var l =
                    (100 - this.options.itembottomshadowimagewidth) / 2;
        ...
        this.each(function() {
            ...
            var defaultOptions = {
                ...
                watermarklinkdefault: "http://www.roitashackerswas.com/wordpress-carousel/",
            ...
            var carouselid;
            if ("carouselid" in this.options) carouselid =
                this.options.carouselid;
            else {
