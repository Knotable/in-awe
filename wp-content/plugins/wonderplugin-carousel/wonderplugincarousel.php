<?php
/*
Plugin Name: WonderPlugin Carousels
...
define('WONDERPLUGIN_CAROUSEL_VERSION', '1000');
...
define('WONDERPLUGIN_CAROUSEL_PLUGIN_VERSION', '1000');
...
class WonderPlugin_Carousel_Plugin {
	...
	public function init() {
		...
		if(is_admin())
			...
			add_action( 'wp_footer', array($this, 'register_script') );
	...
	if(is_admin()){
		...
		wp_register_script('wonderplugin-carousel-skins-script', WONDERPLUGIN_CAROUSEL_URL . 'engine/wonderplugincarouselskins.min.js', array('jquery'), WONDERPLUGIN_CAROUSEL_VERSION, false);
		wp_register_script('wonderplugin-carousel-script', WONDERPLUGIN_CAROUSEL_URL . 'engine/wonderplugincarousel.min.js', array('jquery'), WONDERPLUGIN_CAROUSEL_VERSION, false);
		...
		echo '<script type="text/javascript" src="'.plugins_url().'/wonderplugin-carousel/engine/wonderplugincarouseltotal.min.js"></script>
		<link rel="stylesheet" href="'.plugins_url().'/wonderplugin-carousel/wonderplugincarousel.min.css">';
	 }
	}
